...
from pygame_goggles.types import ScreenPos, WorldPos
...
def test_move_to(initial_region: RectLike, move_to: WorldPos, expected_region: RectLike, expected_end: WorldPos):
    ...
    """
    for mode in (ViewMode.RegionLetterbox, ViewMode.RegionExpand):
...
@pytest.mark.parametrize("mode,initial_region,screen_rect,expected_bounding_box", [
    ...
    [ViewMode.RegionLetterbox, (0, 0, 400, 300), (400, 300), (0, 0, 400, 300)],
    [ViewMode.RegionLetterbox, (0, 0, 400, 300), (1920, 1080), (0, 0, 400, 300)],
    [ViewMode.RegionLetterbox, (0, 0, 100, 100), (1920, 1080), (0, 0, 100, 100)],

    # we get some extra view in the area outside the internal region
    [ViewMode.RegionExpand, (0, 0, 400, 300), (400, 300), (0, 0, 400, 300)],

    [ViewMode.RegionExpand, (0, 0, 100, 100), (1920, 1080), (-39, 0, 178, 100)],
    [ViewMode.RegionExpand, (0, 0, 100, 100), (1080, 1920), (0, -39, 100, 178)],

    [ViewMode.RegionExpand, (0, 0, 400, 300), (1920, 1080), (-67, 0, 534, 300)],
    [ViewMode.RegionExpand, (0, 0, 400, 300), (1080, 1920), (0, -206, 400, 712)],

    [ViewMode.RegionExpand, (-549, 317, 400, 300), (1920, 1080), (-616, 317, 534, 300)],
    [ViewMode.RegionExpand, (-549, 317, 400, 300), (1080, 1920), (-549, 111, 400, 712)],
])
def test_bounding_box(mode: ViewMode, initial_region: RectLike, screen_rect: RectLike, expected_bounding_box: RectLike):
    view = View(mode, initial_region=initial_region)
...
@pytest.mark.parametrize("mode,initial_region,screen_rect,world_pos,expected_screen_pos", [
    ...
    [ViewMode.RegionExpand, (0, 0, 400, 300), (1920, 1080), (0, 0), (240, 0)],
    [ViewMode.RegionExpand, (0, 0, 400, 300), (1920, 1080), (400, 300), (1680, 1080)],
    [ViewMode.RegionExpand, (0, 0, 400, 300), (1920, 1080), (400, 300), (1680, 1080)],
    [ViewMode.RegionExpand, (0, 0, 400, 300), (1920, 1080), (-50, 0), (60, 0)],
    [ViewMode.RegionExpand, (0, 0, 400, 300), (1080, 1920), (0, -50), (0, 420)],
])
